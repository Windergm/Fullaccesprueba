function FindProxyForURL(url, host) {
    ...
    // Conexión directa para URLs que parecen descargas grandes
    if (
        shExpMatch(url, "*.zip") ||
        shExpMatch(url, "*.rar") ||
        shExpMatch(url, "*.7z")  ||
    ...
    if (dnsDomainIs(host, "perplexity.ai") || dnsDomainIs(host, "artlist.io")) return "PROXY 176.126.111.194:8080";
